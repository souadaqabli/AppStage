...
$sql = "SELECT cin, nom, prenom, adresse_pro FROM certificat";
...
<html>
<head>
    <title>Sélectionner les porteurs pour renouvellement</title>
    <style>
        body {
...
<body>
    <h1>Sélectionner les porteurs pour renouvellement</h1>
    <form method="post" action="renouvellement.php">
        <table border="1">
            <tr>
                <th>Choisir</th>
                <th>CIN</th>
